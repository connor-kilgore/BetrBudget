...
**Use Case: Set reminders for expences**

**Actor: user**

**Description: The user set Notifications for Expences to hapen on a certain periodic basis**

**Pre-Condition: User Allows Notifications**

**Post-Condition: They now have a certain periodic expence notification**
...
**Alternate flow**
 ...
 ![IMG_0364](https://user-images.githubusercontent.com/98287880/153781468-ee36d1e2-f760-4fdc-a3e9-d24fc5014bb0.PNG)
